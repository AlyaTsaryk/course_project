...
import edu.kpi.iasa.mmsa.dance_std.configuration.security.jwt.JwtProcessor;
import edu.kpi.iasa.mmsa.dance_std.dto.AccountDto;
import edu.kpi.iasa.mmsa.dance_std.dto.JwtRequestDto;
import edu.kpi.iasa.mmsa.dance_std.dto.JwtResponseDto;
import edu.kpi.iasa.mmsa.dance_std.dto.RegistrationDto;
import edu.kpi.iasa.mmsa.dance_std.model.Account;
import edu.kpi.iasa.mmsa.dance_std.service.RoleService;
import edu.kpi.iasa.mmsa.dance_std.service.UserService;
...
public class AuthenticationController {
    ...
    @PostMapping("/signin")
    public ResponseEntity<JwtResponseDto> signIn(@Valid @RequestBody JwtRequestDto jwtRequestDto) {
